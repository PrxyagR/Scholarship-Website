  ...
  return (
    ...
    >
      <div className="privacy-copy">
        ...
        <p>
          If you use the student dashboard, MaplePath stores the optional grade, province, study-focus preferences, application statuses, and private notes you choose to add. These are stored with your account so the dashboard can work across sessions; do not add sensitive personal information.
        </p>
